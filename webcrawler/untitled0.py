...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 13 19:17:49 2024
...
with open("Crawl_Report.txt", "w") as f:
    f.write(f"Name: Jared Vaughn\n")
    f.write(f"USC ID: 4405675796\n")
    f.write(f"News site crawled: https://www.latimes.com\n")
    f.write(f"Number of threads: 4\n")
    f.write(f"\n")
